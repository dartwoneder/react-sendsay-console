// override https://github.com/vankop/jsoneditor-react
...
export default class Editor extends Component {
  ...
  componentDidMount() {
    const {allowedModes, innerRef, htmlElementProps, tag, onChange, onError, ...rest} = this.props;
  ...
  componentDidUpdate({allowedModes, schema, name, theme, schemaRefs, innerRef, htmlElementProps, tag, onChange, onError, ...rest}) {
    if (this.jsonEditor) {
  ...
  shouldComponentUpdate({htmlElementProps, hasError}) {
    return htmlElementProps !== this.props.htmlElementProps || hasError !== this.props.hasError;
  }
  ...
  render() {
    const {htmlElementProps, tag, className} = this.props;
